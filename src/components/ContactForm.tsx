...
import { sendEmailAction } from "@/actions/sendEmailAction"; // server action exported from actions

const ContactForm = () => {
  return (
    <Card>
      {/* use the server action exported from src/actions/sendEmailAction.ts */}
